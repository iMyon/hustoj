...
?>
	...
	<form method=POST >
	<p align=center><font size=4 color=#333399>添加考试</font></p>
...
?>
	...
	<br>问题（逗号分隔）:<input class=input-xxlarge type=text size=60 name=cproblem value="<?php echo isset($plist)?$plist:""?>">
